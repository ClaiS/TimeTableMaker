...
const s = {
  ...
  chip:      { padding: '6px 14px', border: '1px solid #E5E7EB', borderRadius: 14, fontSize: 13, fontWeight: 600, color: '#64748B', background: '#fff', cursor: 'pointer', transition: 'all .15s' },
  ...
  cardDay:   { fontSize: 15, fontWeight: 700, color: '#0F172A' },
  badge:     { fontSize: 12, fontWeight: 700, padding: '3px 10px', borderRadius: 10 },
  badgeGreen:{ background: '#DCFCE7', color: '#15803D' },
  badgeRed:  { background: '#FEF2F2', color: '#DC2626' },
  emptyTx:   { padding: 16, textAlign: 'center', fontSize: 13, color: '#94A3B8' },
  sessLabel: { padding: '5px 14px', margin: '4px 0 0' },
  slot:      { display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', borderBottom: '1px solid #F9FAFB' },
  dot:       { width: 9, height: 9, borderRadius: 4.5, background: '#22C55E', flexShrink: 0 },
  slotTier:  { fontSize: 14, fontWeight: 700, color: '#0F172A' },
  slotTime:  { fontSize: 12, color: '#94A3B8', marginTop: 2 },
  freeTag:   { background: '#DCFCE7', color: '#15803D', fontSize: 12, fontWeight: 700, padding: '3px 10px', borderRadius: 5 },
  occWrap:   { padding: '9px 14px', background: '#FAFAFA', borderTop: '1px solid #F3F4F6' },
  occLabel:  { fontSize: 11, color: '#94A3B8' },
  occChip:   { fontSize: 11, fontWeight: 600, padding: '3px 8px', borderRadius: 4, border: '1px solid' },
}
